...
@Entity
@Table(name = "archived_contact_request")
public class ArchivedContactRequest {
     ...
     */
    public ArchivedContactRequest(String fullName, String email, String phone, String subject, String message) {
